...
def register_routes(app):
    ...
    def use_move():
        ...
        print(f"[TIMING] /api/battle/use-move: {time.time() - t0:.4f} seconds")
        return resp
    ...
    def switch_pokemon():
        ...
        print(f"[TIMING] /api/battle/switch-pokemon: {time.time() - t0:.4f} seconds")
        return resp
    ...
    def get_battle_state():
        ...
        print(f"[TIMING] /api/battle/state: {time.time() - t0:.4f} seconds")
        return resp
